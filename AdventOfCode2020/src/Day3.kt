...
class Day3 : AOC_Runner() {
    ...
    val map = allLines.map { it.toCharArray() }
    val tree = '#'

    override fun executeGoal_1() {
        var treesEncountered = checkSlope(1, 3)
        println(treesEncountered)
    }

    private fun checkSlope(posYIncr: Int, posXIncr: Int): Int {
        var posY = 0
    ...
    override fun executeGoal_2() {
        ...
        slopes.forEach{
            val posX = it.first
            val posY = it.second
            encounteredTrees.add(checkSlope(posY, posX))
        }
